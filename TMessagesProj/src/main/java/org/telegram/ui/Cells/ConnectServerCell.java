...
public class ConnectServerCell extends FrameLayout {
    ...
    public ConnectServerCell(Context context, boolean dialog) {
        super(context);
        ...
        checkImage.setImageResource(R.drawable.list_check);
    ...
    public void setServerInfo(LocaleController.ConnectServerInfo serverInfo, String desc, boolean divider) {
        textView.setText(desc != null ? desc : serverInfo.name);
        textView2.setText(serverInfo.hostAddress);
    ...
    public LocaleController.ConnectServerInfo getCurrentServerInfo() {
