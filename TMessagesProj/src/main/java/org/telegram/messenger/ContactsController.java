...
//        query.add(builder.build());
        ...
        builder.withValue(ContactsContract.Data.DATA2, "TMessager Profile");
        ...
        builder.withValue(ContactsContract.Data.DATA1, user.id);
        builder.withValue(ContactsContract.Data.DATA2, "TMessager Voice Call");
        ...
        builder.withValue(ContactsContract.Data.DATA1, user.id);
        builder.withValue(ContactsContract.Data.DATA2, "TMessager Video Call");
