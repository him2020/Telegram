...
public class BuildVars {
    ...
    public static int APP_ID = 2955778; //4;
    public static String APP_HASH = "f6e45606a0ba57bdd85ef400ccc0f1d0"; //"014b35b6184100b085b0d0572f9b5103";
    ...
    static {
        if (ApplicationLoader.applicationContext != null) {
            ...
            LOGS_ENABLED = DEBUG_VERSION || sharedPreferences.getBoolean("logsEnabled", LOGS_ENABLED);
        }
    }
